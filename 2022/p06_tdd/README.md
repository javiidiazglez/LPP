...
# Documentación:
- ### Expectativa para comprobar que existe una clase Vehiculo - Vacía (FALLA)
  ```rb
  require 'vehiculo'
  describe Vehiculo do
  end
  ```
- ### Expectativa para comprobar la clase Vehiculo - Vacía (FUNCIONA) y pasan las pruebas correctamente.
  ```rb
  class Vehiculo
  end
  ```
- ### Expectativa para comprobar el initialize (FALLA)
  ```rb
  before :each do
  ...
  ``` 
- ### Creación del initialize (FUNCIONA) y pasan las pruebas correctamente.
  ```rb
  ...
  ```
- ### Expectativa para las pruebas to_s (FALLA)
  ```rb
  it "Se obtiene una cadena con la información del Coche Ocasional correctamente formateada" do
...
- ### Creación del to_s (FUNCIONA) y pasan las pruebas correctamente.
  ...
  ```
- ### Expectativa para las funcionalidades de conversor de distancia (FALLA)
  ```rb
  ...
  ```
- ### Creación de la funcionalidad conversor_distancia (FUNCIONA)  y pasan las pruebas correctamente.
  ```rb
  ...
  ```
## Herramienta RSpec
1. Instalar la gema Rspec 
```console
gem install rspec
```
2. Creación del fichero .rspec, el directorio spec/ y el fichero spec/spec_helper.rb)
```console
rspec --init
```